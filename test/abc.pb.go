...
import (
	...
	github_com_regen_network_chain_proto_test_iface "github.com/soominhyunwoo/chain-proto/test/iface"
	io "io"
	math "math"
	math_bits "math/bits"
)
...
func (this *ABC) GetMsg() github_com_regen_network_chain_proto_test_iface.Msg {
...
func (this *ABC) SetMsg(value github_com_regen_network_chain_proto_test_iface.Msg) error {
	if value == nil {
		this.Sum = nil
		return nil
	}
...
func (this *ABCNonPointer) GetMsg() github_com_regen_network_chain_proto_test_iface.Msg {
	if x := this.GetA(); x != nil {
		return x
	}
	if x := this.GetB(); x != nil {
...
func (this *ABCNonPointer) SetMsg(value github_com_regen_network_chain_proto_test_iface.Msg) error {
	if value == nil {
		this.Sum = nil
		return nil
	}
